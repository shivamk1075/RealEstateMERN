            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            <input type="number"  
                            id='regularPrice' min='1' max='10' required className='border border-gray-300 p-3 rounded-lg'/>
                         ...
                         <div className="flex items-center gap-2">
                            <input type="number"  
                            id='discountPrice' min='1' max='10' required className='border border-gray-300 p-3 rounded-lg'/>
                            <div className="flex flex-col items-center">
                ...
                <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opactiy-95 disabled:opacity-80'>Create Listing</button>
                </div>
            </form>
        </main>
    )
